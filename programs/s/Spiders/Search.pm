...
####### ---------------------start---------------------end------------
#############################=============selected=======############
##### Version 12.0.0 both ppm and th can be used ################
	if($error_unit==2)
	{
...
#### Version 12.0.0 in order to increase the speed #####################
...
###### Version 12.0.0 fix a bug: using frag tolerance instead of mass tolerance	
...
######### Version 12.0.0 fix a bug: for low resolution, using exp mass range rather than theoretical mass range	
...
####### Version 12.0.0; increase search speed 
